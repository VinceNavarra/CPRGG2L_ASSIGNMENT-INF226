...
public class ColorMenu extends JFrame{
    ...
    JList colorList;
    // Color arrays
    private String[] colorNameArray = {"GRAY", "LIGHT GRAY", "WHITE", "PINK", "BLUE"};
    private Color[] colorClassArray = {Color.GRAY, Color.LIGHT_GRAY, Color.WHITE, Color.PINK, Color.BLUE};
